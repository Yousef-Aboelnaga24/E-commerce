...
function AdminDashboard() {
  ...
  const stats = [
    { name: 'Total Revenue', value: `$${revenue}`, icon: <FiDollarSign className="w-6 h-6" />, change: '+20.1%', changeType: 'positive' },
    { name: 'Active Users', value: users, icon: <FiUsers className="w-6 h-6" />, change: '+180.1%', changeType: 'positive' },
    { name: 'Total Orders', value: orders, icon: <FiShoppingBag className="w-6 h-6" />, change: '+19%', changeType: 'positive' },
  ];
