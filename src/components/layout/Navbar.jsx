          ...
          <div className="hidden lg:flex flex-1 max-w-md mx-8">
            <div className="relative w-full">
              <Input
                ...
                className="w-full pl-4 pr-12 py-2 rounded-l-lg border-none focus:ring-2 focus:ring-blue-300 text-gray-900"
                value={searchValue}
              ...
              <button
                ...
                className="absolute right-0 top-0 h-full px-4 bg-blue-700 hover:bg-blue-800 rounded-r-lg transition-colors"
              >
                <MdSearch size={20} />
              </button>
            </div>
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 py-3">
          ...
          <div className="lg:hidden">
            <div
              className={`overflow-hidden transition-all duration-300 ${isMobileMenuOpen ? "max-h-96" : "max-h-0"
                }`}
            >
